...
module HaskellWorks.Data.Json.Internal.New.RawIbsBSpec
  ( spec
  , bitShowIbOf
  ) where
...
import qualified HaskellWorks.Data.Json.Internal.New.RawIbsB   as RIB
...
rawInterestBitsOf bs = S.unstreamVector ((BS.length bs + 63) `div` 64) (fst (RIB.extractRawInterestBits (LBS.fromStrict bs)))
